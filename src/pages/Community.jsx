    ...
    <>
      ...
      <section className="w-full bg-white py-24 px-6 md:px-20">
        ...
        <div className="w-full flex justify-center mt-20">
         ...
         <button
  onClick={() => navigate("/featured-bikes")}
  className="px-16 py-4 bg-black text-white rounded-full border-2 border-green-500 font-semibold tracking-wide hover:bg-green-500 hover:text-black hover:scale-105 transition duration-300"
>
