      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="border border-gray-300 rounded-2xl p-8 text-center hover:shadow-xl transition">
          ...
          <h3 className="text-xl font-bold mb-4">
            Kawasaki Riders Meetup
          </h3>
          <p className="text-gray-600 mb-6">
            Join Kawasaki riders for an exciting meetup with rides,
            networking, and community bonding.
          </p>
          <button className="px-8 py-3 bg-black text-white rounded-full hover:bg-green-500 hover:text-black transition">
            View Details
          </button>
        </div>
        <div className="border border-gray-300 rounded-2xl p-8 text-center hover:shadow-xl transition">
          ...
          <p className="text-gray-600 mb-6">
            Experience Kawasaki superbikes on a professional racing track
        ...
        <div className="border border-gray-300 rounded-2xl p-8 text-center hover:shadow-xl transition">
          ...
          <p className="text-gray-600 mb-6">
            Explore new Kawasaki models, technology showcases, and
            exclusive offers.
          </p>
          <button className="px-8 py-3 bg-black text-white rounded-full hover:bg-green-500 hover:text-black transition">
            Explore Event
